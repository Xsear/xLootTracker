...
LANG = {
	...
	Panels_Display_AssignedTo_Hide_nil_Label        =	"Hide AssignedTo Not assigned",
	Panels_Display_AssignedTo_Hide_nil_ToolTip		=	"Only show AssignedTo text when item has been assigned - don\'t display \"Not assigned\".",
